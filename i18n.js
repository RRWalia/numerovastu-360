...
var I18N = {
  "en": {
    ...
    "ui": {
      ...
      "brandSub": "Lo Shu Foundation & Ank Jyotish Dasha",
      "editDetails": "Edit Details",
      "savePrint": "Save / Print Report",
      "skipLink": "Skip to main content",
      "invocation": "ॐ श्री गणेशाय नमः",
      "reportHeroTitle": "Remedy Report — {name}",
      "reportHeroMeta": "DOB <strong>{dob}</strong>{birthLine} · Focus: {goals}",
      "reportGenLine": "Report generated {date} · computed locally on your device — nothing leaves your browser",
      "readingGuideTitle": "How to read this report",
      "readingGuideDriver": "<strong>Driver (Moolank)</strong> — your mind, personality and day-to-day energy; <strong>Conductor (Bhagyank)</strong> — your destiny path. Both derive from your birth date.",
      "readingGuideGrid": "<strong>Lo Shu grid</strong> — which of the nine number energies (1–9, each ruled by a planet) are present, repeated or missing in your birth date and name. Section {grid} reads every gap: your first gaps get full remedy kits in Section {kits}, the rest get quick balancers, and the Remedy Triage stages one acute target at a time.",
      "readingGuideFlow": "Numbered sections build from identity → remedies → timing → Vastu across the Foundation, Timeline and Cockpit tabs. The <strong>40-Day Activation Plan</strong> at the end of Foundation is your starting point — practise it consistently for 40 days.",
      "reportClosingBrand": "NumeroVastu 360 — Private Report",
      "reportClosingDisclaimer": "Guidance based on classical Vedic numerology &amp; Vastu principles — supportive practices, not a substitute for professional medical, legal or financial advice.",
      "born": "Born",
      "statusPrivate": "Private & local",
      "statusKnowledge": "Knowledge pack v{ver}",
      "statusApp": "App v2.15.0 · On-device engine",
      "statusBuild": "Build 2026-09-08",
      ...
      "introDesc": "Enter your details once. We build your classic Lo Shu Foundation (Birth, Name and Combined grids), calculate Driver & Conductor, and map a separate Ank Jyotish Dasha timeline with active Vastu zones, then check your name, mobile, goals and space privately on your device.",
      "reportLanguage": "Report Language",
      "reportLanguageDesc": "Choose your preferred language for the report. You can switch anytime:",
      "personalDetails": "Personal Details",
      "fullName": "Everyday / Professional Name",
      "fullNamePlaceholder": "As used daily, e.g. Amar K Sambhvani",
      "fullNameHint": "The name the world uses — business card, email signature, bank card, LinkedIn. It drives your main Name Number.",
      "legalName": "Full Legal Name (as on Aadhaar / PAN)",
      "legalNameOptional": "(optional — but unlocks the strongest name remedy)",
      "legalNamePlaceholder": "e.g. Amarkumar Kishorbhai Sambhvani",
      "legalNameHint": "The exact string on statutory records. Its middle name / patronymic (Kishorbhai → K) gives the engine your real family initial — it will never invent a random letter.",
      "dob": "Date of Birth",
      "dobPlaceholder": "dd-mm-yyyy e.g. 05-08-1976",
      "dobHint": "Day-month-year order, e.g. 05-08-1976.",
      ...
      "healthTagsLabel": "Health details (optional)",
      "healthTagsHint": "Optional — refines lunar remedy safety. Allergies / Respiratory / Cold switches Moon kits to their warm form.",
      "healthTagRespiratory": "Allergies / Respiratory / Cold",
      "healthTagHeat": "Acidity / Inflammation / Heat",
      "healthTagFatigue": "Joints / Digestion / Fatigue",
      ...
      "birthPlaceHint": "Tier 2 — anchors the sky over your birthplace. 7,000+ Indian towns plus 630 curated world cities, fully offline. Type a prefix for suggestions, paste coordinates like “28.41, 77.32”, or look up once via Photon (opt-in).",
      "photonLookup": "Look up online (Photon)",
      "loadGulfAtlas": "Load Gulf cities (offline)",
      "loadWorldAtlas": "Load world cities 100k+ (offline)",
      "photonHint": "Photon is opt-in: only the place name you typed is sent to photon.komoot.io. The chosen city string is cached locally — never coordinates or your chart.",
      "photonNeedQuery": "Type a city name first, then look up.",
      "photonNoResults": "No Photon matches. Try a nearby district, or enter coordinates.",
      "photonError": "Photon lookup failed. Stay offline or enter coordinates.",
      "atlasLoaded": "Offline atlas loaded.",
      "atlasAlreadyLoaded": "That atlas is already loaded.",
      "atlasLoadError": "Could not load that atlas chunk.",
      "birthGeoManual": "Manual coordinates (optional)",
      "birthLat": "Latitude",
      "birthLon": "Longitude",
      "birthTz": "Time zone (hours from UTC)",
      "birthGeoManualHint": "Overrides the atlas when you know the exact spot. Time zone defaults to +5.5 if left blank. A nearby district within 25 km (Lagna shift under 0.1°) is used when the name is unknown.",
      ...
      "partnerBirthTime": "Partner's Exact Birth Time (optional — unlocks Moon & Chandra-bala)",
      "partnerBirthTimeHint": "Tier 2 — the Moon moves about 13°20′ a day, so without an exact time the partner's Moon Rashi and Nakshatra cannot be pinned. Left blank, the report says so instead of assuming a noon birth.",
      "partnerBirthPlace": "Partner's Birth City / Place (optional — unlocks Moon & Chandra-bala)",
      "partnerBirthPlacePlaceholder": "e.g. New Delhi, India",
      "partnerBirthPlaceHint": "Tier 2 — uses the same offline atlas as your own birthplace (7,000+ Indian towns plus the curated world list). Type a prefix for suggestions or paste coordinates like “28.41, 77.32”. Nothing is sent anywhere.",
      "partnerTierNote": "Without the partner's time and place the report still gives the full Driver / Conductor comparison (Tier 1) and states plainly that Chandra-bala was not computed — it never guesses a Moon.",
      ...
      "errLegalName": "Please check the legal name — letters are required.",
      "errDob": "Please enter a valid date of birth in dd-mm-yyyy order (e.g. 05-08-1976).",
      "errMobile": "Please enter a valid mobile number (8+ digits, not all zeros).",
      "errGoals": "Select at least one focus area.",
      "navSummary": "Summary",
      "moduleNavigation": "Report modules",
      "moduleQuickNavigation": "Module navigation",
      "tabFoundation": "Foundation · Lo Shu",
      "tabTimeline": "Timeline · Ank Jyotish Dasha",
      "tabCockpit": "Cockpit · Practitioner",
      "navCockpit": "Cockpit",
      "cockpitPanelTitle": "Your one-page clinical cockpit",
      "cockpitPanelDesc": "A single printable consultation sheet: identity, both grids, the live Dasha stack judged by classical Sambhandha, the triaged prescription and graded event windows. It never recalculates anything — it condenses.",
      "navFoundation": "Foundation",
      "navTimeline": "Timeline",
      "navLoShu": "Lo Shu Blueprint",
      "timelineNavigation": "Timeline navigation",
      "backToTimeline": "Timeline top",
      "foundationPanelTitle": "Your psychological blueprint and practice",
      "foundationPanelDesc": "Use the classic Lo Shu Birth, Name and Combined grids to understand patterns, then build your practical 40-day activation plan.",
      "timelinePanelTitle": "Your Dasha roadmap",
      "timelinePanelDesc": "Read the current Ank Jyotish Dasha stack, active Vastu zone and life-event windows as a time-based roadmap. This proportional numerology clock is not classical Vimshottari and never uses either grid to alter timing.",
      "navProfile": "Profile",
      ...
      "clinicalNoticeTitle": "Ethical &amp; Health Notice",
      "clinicalNoticeBody": "Numerology, Vedic Dasha timelines, and elemental tattva suggestions are traditional interpretive frameworks for personal reflection and lifestyle harmonization. They do not constitute medical, psychological, legal, or financial diagnoses. Always consult a licensed healthcare professional before initiating new dietary fasts, herbal routines, or intense breathwork regimens.",
      "sadhanaTitle": "Practice Depth — Scaled Sadhana",
      "sadhanaDesc": "Choose the daily bandwidth you can genuinely sustain. The scale sizes the practice — it never changes your Lo Shu remedy target and never overrides a clinical guardrail.",
      "sadhanaBeginnerTitle": "Beginner · Minimalist / Corporate",
      "sadhanaBeginnerDesc": "11× short mantra or the 11× wish-paper affirmation · 5-minute breathwork · colour cue · declutter one space you see daily",
      "sadhanaIntermediateTitle": "Intermediate · Practitioner / Sadhak",
      "sadhanaIntermediateDesc": "27× japa (quarter mala) on a dedicated mala · aushadhi snan on your power day · weekly power-day charity",
      "sadhanaClassicalTitle": "Classical · Full Sadhana",
      "sadhanaClassicalDesc": "108× japa (one full mala) on a dedicated mala · full aushadhi snan · weekly power-day charity",
      "sadhanaHint": "Default: the Practitioner / Sadhak dose. You can change this any time in Edit Details.",
      "sadhanaSummaryLabel": "Practice depth",
      "sadhanaCardTitle": "Your Scaled Sadhana — practice depth",
      "sadhanaCardDesc": "Your chosen practice depth. It sizes the daily practice only — the Lo Shu target, the triage tiers and every clinical guardrail stay exactly as prescribed.",
      "sadhanaRowJapa": "Japa / affirmation dose",
      "sadhanaRowMala": "Mala",
      "sadhanaRowBreath": "Breathwork",
      "sadhanaRowSnan": "Aushadhi snan",
      "sadhanaRowCharity": "Charity cadence",
      "sadhanaRowSpace": "Space",
      "sadhanaJapaBeginner": "11× short mantra daily. On days japa is not possible, write the wish-paper affirmation 11 times instead.",
      "sadhanaJapaIntermediate": "27× daily (quarter mala) with the beej or short mantra given in the Remedy Triage card.",
      "sadhanaJapaClassical": "108× daily (one full mala) — the full classical count.",
      "sadhanaJapaHeld": "held this cycle by the Remedy Triage; the dose resumes when the target activates.",
      "sadhanaMalaDedicated": "One dedicated mala, kept only for this japa.",
      "sadhanaMalaOptional": "No mala required on the Minimalist track — count the 11× on your fingers.",
      "sadhanaBreathBeginner": "5 minutes of easy breathwork — a slow, even breath, no retention.",
      "sadhanaBreathIntermediate": "10 minutes of the breathwork anchors in Section 4A, before or after the japa.",
      "sadhanaBreathClassical": "20 minutes of the full Section 4A breathwork set, after the aushadhi snan.",
      "sadhanaBreathSub": "If a hold feels forced, or you feel dizzy, stop and return to normal breathing.",
      "sadhanaSnanBeginner": "A quick shower with your colour cue; keep it simple and repeatable.",
      "sadhanaSnanIntermediate": "Full aushadhi snan on your power day (Section 4A form).",
      "sadhanaSnanClassical": "Full aushadhi snan on every practice day (Section 4A form).",
      "sadhanaCharityBeginner": "Monthly, or on your power day when it fits — one act is enough.",
      "sadhanaCharityPractitioner": "Weekly, on your power day (Driver / Conductor table in the plan).",
      "sadhanaSpaceBeginner": "Declutter one space you see daily; tidy one surface each week.",
      "sadhanaSpacePractitioner": "Keep the active sector clutter-free each week (see Timeline).",
      "sadhanaScaleNote": "The scale sizes the practice; it never changes the Lo Shu remedy target, and a clinical guardrail always caps the dose (Moon-cold warm form, dosha × planet mild form, solar-load moderation, under-18 gem deferral).",
      "sadhanaIntenseNotice": "Classical depth adds an intense breathwork and aushadhi snan regimen — clear it with a licensed healthcare professional first (see the Ethical & Health Notice in the Northstar Summary).",
      "sadhanaMinorNote": "Under-18 chart: a parent or guardian supervises this practice, and the breathwork stays gentle — no breath-retention holds.",
      "sadhanaEditHint": "Change this any time in Edit Details → Practice Depth.",
      "sadhanaDoseBeginner": "11× daily (short mantra — or the wish-paper affirmation on days japa is not possible), same time each day",
      "sadhanaDoseIntermediate": "27× daily (quarter mala), same time each day",
      "sadhanaDoseClassical": "108× daily (one full mala), same time each day",
      "sadhanaDeepenBeginner": "Deepen only if the dose feels steady: raise the sunrise mantra to 27 times (a quarter mala) and write down what you notice.",
      "sadhanaDeepenIntermediate": "Deepen the practice: raise the sunrise mantra to 108 times (one full mala) and write down what you notice.",
      "sadhanaDeepenClassical": "You are already at the full classical count: hold the 108× mala steady and write down what you notice on your power day.",
      "secProfile": "Core Numerology Profile",
      "secTraits": "Your Core Nature — Traits, Strengths & Shadows",
      "secVedicGrid": "Vedic Birth Grid — Planetary Strength Indicators",
      "secLoShuGrid": "Lo Shu Blueprint — Your Foundation",
      "secVedicCompare": "Advanced Vedic Comparison",
      "secWeak": "Lo Shu Remedy Kits",
      "secTattva": "Vedic Plane Harmonization — Elemental Tattva Balancing",
      "secTattvaDesc": "Physical, breathwork, and herbal anchors to stabilize deficient natal planes. These run alongside your 40-day Lo Shu practice without adding ritual fatigue.",
      "secZodiac": "Your Vedic Sun-sign Reference — {sign}",
      ...
      "secTiming": "Long-range Personal-Year Context",
      "secDasha": "Dasha Timeline — Life Event Windows",
      "fieldModeOn": "Field mode",
      "fieldModeOff": "Exit field mode",
      "fieldModeToggle": "Toggle field read mode",
      "fieldModeOnToast": "Field mode on — larger type, single column, reduced clutter.",
      "fieldModeOffToast": "Field mode off.",
      "vimshottariTitle": "Classical Vimshottari Dasha — Moon-Nakshatra Anchored",
      "vimshottariKicker": "Vedic · nakshatra-anchored · fixed 120-year cycle",
      "vimshottariIntro": "This is the classical Vedic Vimshottari stack: it is anchored on the birth Moon's nakshatra and uses the fixed lord durations (Ketu 7, Venus 20, Sun 6, Moon 10, Mars 7, Rahu 18, Jupiter 16, Saturn 19, Mercury 17 years). It is computed from your Moon position, not from your Moolank, and runs independently of the Ank Jyotish Dasha roadmap.",
      "vimshottariAnchorLabel": "Anchor",
      "vimshottariBalanceLabel": "Balance of the birth lord at birth",
      "vimshottariBalanceNote": "Each nakshatra spans 13°20′. You were born part-way through it, so that unspent fraction is deducted from the starting lord's period and the remaining years carry over.",
      "vimshottariLadderTitle": "Mahadasha ladder (fixed 120-year cycle)",
      "vimshottariCurrentTitle": "Active Vimshottari stack",
      "vimshottariCompareTitle": "Why this differs from the Ank Jyotish roadmap",
      "vimshottariCompareAgree": "The two clocks currently agree on the ruling lord. That is a coincidence of these particular anchors, not a rule — the two systems remain independent.",
      "vimshottariCompareDiffer": "The two clocks disagree here, and that is expected rather than an error. The Ank Jyotish roadmap is seeded from your Moolank on a 45-year proportional base; the Vimshottari stack is anchored on your Moon's nakshatra on the classical 120-year base. Neither overrides the other — read them as two separate Vedic traditions, the way a Jyotishi and an Ank Jyotishi would each report from their own shastra.",
      "vimshottariNoTime": "The classical Vimshottari stack needs your exact birth time and a recognised birthplace, because it is anchored on the Moon's nakshatra rather than on your birth date alone. Add both in the intake form to unlock it.",
      "vimshottariAge": "Ages",
      "vimshottariBalanceTag": "balance carried from birth",
      "vimshottariMD": "Mahadasha",
      "vimshottariAD": "Antardasha",
      "vimshottariPD": "Pratyantar",
      "vimshottariElapsed": "elapsed",
      "vimshottariBoundary": "This module never feeds Lo Shu remedies, Vastu zones or the Ank Jyotish event windows. It is a standalone classical read-out.",
      "dashaJudgeNote": "The roadmap above is our proportional Ank Jyotish clock (MD × AD ÷ 45): each Mahadasha lasts exactly its own number of years and every sub-period is scaled relative to planetary weight, keeping the Mahadasha, Antardasha and Pratyantar levels nested exactly. It is <strong>not</strong> classical Vimshottari Dasha and makes no nakshatra-based claim — the separate <em>Classical Vimshottari</em> card in this section is the true nakshatra-anchored stack, and the two are allowed to disagree. <em>Note on alternative schools:</em> some modern practitioners run Antardashas as flat 1-year blocks aligned to your solar return (birthday to birthday); both schools are in live use and dates can shift slightly between them. Event windows use only the active Mahadasha–Antardasha significator pattern; neither Lo Shu nor Vedic birth-grid counts can change them.",
      "dashaLadderNote": "The ladder is computed well past the 80-year average-lifespan horizon so every life-event band — including wealth & business till 75 — stays covered for the whole of life.",
      "dashaCoverageNote": "Coverage: wealth & business windows are scanned across ages 21–75, and every Dasha horizon assumes an 80-year average lifespan. Once a classical band closes, late significator windows are scanned till age 80 (or 15 years ahead, whichever reaches further) rather than leaving the card blank.",
  ...
  "hi": {
    ...
    "ui": {
      "brandName": "NumeroVastu 360",
      "brandSub": "लो शू Foundation और अंक-ज्योतिष दशा",
      ...
      "reportHeroMeta": "जन्म तिथि: <strong>{dob}</strong>{birthLine} · मुख्य लक्ष्य: {goals}",
      "reportGenLine": "रिपोर्ट निर्मित {date} · आपके डिवाइस पर स्थानीय रूप से गणना — कुछ भी आपके ब्राउज़र से बाहर नहीं जाता",
      "readingGuideTitle": "इस रिपोर्ट को कैसे पढ़ें",
      "readingGuideDriver": "<strong>ड्राइवर (मूलांक)</strong> — आपका मन, व्यक्तित्व और दिन-प्रतिदिन की ऊर्जा; <strong>कंडक्टर (भाग्यांक)</strong> — आपका भाग्य-मार्ग। दोनों आपकी जन्म-तिथि से बनते हैं।",
      "readingGuideGrid": "<strong>लो शू ग्रिड</strong> — नौ अंक-ऊर्जाओं (1–9, प्रत्येक का स्वामी एक ग्रह) में से कौन-सी आपकी जन्म-तिथि और नाम में उपस्थित, दोहरी या अनुपस्थित है। खंड {grid} हर खाली अंक को पढ़ता है: पहले खाली अंकों को खंड {kits} में पूर्ण उपाय किट मिलती हैं, शेष को त्वरित संतुलक, और Remedy Triage एक समय में एक ही तीव्र लक्ष्य रखता है।",
      "readingGuideFlow": "क्रमांकित खंड पहचान → उपाय → समय → वास्तु के क्रम में Foundation, Timeline और Cockpit टैब में बने हैं। Foundation के अंत में <strong>40-दिवसीय सक्रियण योजना</strong> आपका प्रारंभ-बिंदु है — इसे 40 दिन लगातार करें।",
      "reportClosingBrand": "NumeroVastu 360 — निजी रिपोर्ट",
      "reportClosingDisclaimer": "शास्त्रीय वैदिक अंकशास्त्र और वास्तु सिद्धांतों पर आधारित मार्गदर्शन — सहायक अभ्यास, पेशेवर चिकित्सा, कानूनी या वित्तीय सलाह का विकल्प नहीं।",
      "born": "जन्म",
      "statusPrivate": "गोपनीय एवं सुरक्षित",
      "statusKnowledge": "ज्ञान संग्रह v{ver}",
      "statusApp": "ऐप v2.15.0 · ऑन-डिवाइस गणना",
      "statusBuild": "संस्करण 2026-09-08",
      ...
      "introDesc": "अपनी जानकारी एक बार दर्ज करें। हम आपकी क्लासिक लो शू Foundation (जन्म, नाम और संयुक्त ग्रिड) बनाते हैं, मूलांक-भाग्यांक निकालते हैं, और अलग अंक-ज्योतिष दशा समय-रेखा व सक्रिय वास्तु क्षेत्र दिखाते हैं — सब आपके डिवाइस पर निजी रूप से। यह अनुपातिक numerology clock शास्त्रीय विम्शोत्तरी दशा नहीं है।",
      ...
      "fullName": "दैनिक / व्यावसायिक नाम",
      "fullNamePlaceholder": "जो नाम आप दैनिक जीवन में लिखते हैं, जैसे: अमर के. संभवानी",
      "fullNameHint": "यह वही नाम है जो दुनिया प्रयोग करती है — विज़िटिंग कार्ड, ईमेल हस्ताक्षर, बैंक कार्ड, LinkedIn। यही आपका मुख्य नामांक तय करता है।",
      "legalName": "पूरा कानूनी नाम (आधार / PAN अनुसार)",
      "legalNameOptional": "(वैकल्पिक — परन्तु सबसे सशक्त नाम-उपाय खोलता है)",
      "legalNamePlaceholder": "जैसे: अमरकुमार किशोरभाई संभवानी",
      "legalNameHint": "सरकारी रिकॉर्ड पर अंकित ठीक वही नाम। इसका मध्य नाम / पितृ-नाम (किशोरभाई → K) इंजन को आपका असली पारिवारिक आद्यक्षर देता है — कोई काल्पनिक अक्षर कभी नहीं जोड़ा जाता।",
      "dob": "जन्म तिथि (Date of Birth)",
      "dobPlaceholder": "दिन-माह-वर्ष e.g. 05-08-1976",
      "dobHint": "दिन-माह-वर्ष क्रम में, जैसे 05-08-1976।",
      ...
      "healthTagsLabel": "स्वास्थ्य विवरण (वैकल्पिक)",
      "healthTagsHint": "वैकल्पिक — चंद्र उपायों की सुरक्षा तय करता है। एलर्जी / श्वसन / सर्दी चुनने पर चंद्र किट उष्ण रूप में चलते हैं।",
      "healthTagRespiratory": "एलर्जी / श्वसन / सर्दी",
      "healthTagHeat": "एसिडिटी / सूजन / गर्मी",
      "healthTagFatigue": "जोड़ / पाचन / थकान",
      ...
      "birthPlaceHint": "लेवल २ — ७,०००+ भारतीय कस्बे और ६३० चयनित विश्व शहर, पूरी तरह ऑफ़लाइन। नाम लिखें, निर्देशांक भरें, या एक बार Photon से खोजें (आपकी मर्ज़ी)।",
      "photonLookup": "ऑनलाइन खोजें (Photon)",
      "loadGulfAtlas": "खाड़ी शहर लोड करें (ऑफ़लाइन)",
      "loadWorldAtlas": "विश्व शहर १ लाख+ लोड करें (ऑफ़लाइन)",
      "photonHint": "Photon वैकल्पिक है: केवल आपके लिखे स्थान-नाम को photon.komoot.io भेजा जाता है। चुना हुआ शहर-नाम स्थानीय रूप से सहेजा जाता है — निर्देशांक या कुंडली नहीं।",
      "photonNeedQuery": "पहले शहर का नाम लिखें, फिर खोजें।",
      "photonNoResults": "Photon पर मेल नहीं मिला। पास का जिला आज़माएँ या निर्देशांक लिखें।",
      "photonError": "Photon खोज असफल रही। ऑफ़लाइन रहें या निर्देशांक लिखें।",
      "atlasLoaded": "ऑफ़लाइन एटलस लोड हो गया।",
      "atlasAlreadyLoaded": "यह एटलस पहले से लोड है।",
      "atlasLoadError": "एटलस खंड लोड नहीं हो सका।",
      "birthGeoManual": "मैन्युअल निर्देशांक (वैकल्पिक)",
      "birthLat": "अक्षांश",
      "birthLon": "देशांतर",
      "birthTz": "समय क्षेत्र (UTC से घंटे)",
      "birthGeoManualHint": "जब स्थान पता हो तो एटलस को ओवरराइड करता है। खाली छोड़ने पर समय क्षेत्र +5.5 माना जाता है। २५ किमी के भीतर का जिला (लग्न अंतर ०.१° से कम) नाम न मिलने पर प्रयुक्त होता है।",
      ...
      "partnerBirthTime": "साथी का सटीक जन्म समय (वैकल्पिक — चंद्र व चंद्र-बल खोलता है)",
      "partnerBirthTimeHint": "लेवल २ — चंद्रमा प्रतिदिन लगभग १३°२०′ चलता है, इसलिए सटीक समय के बिना साथी की चंद्र राशि और नक्षत्र तय नहीं हो सकते। खाली छोड़ने पर रिपोर्ट दोपहर का जन्म मान लेने के बजाय स्पष्ट कहती है कि गणना नहीं हुई।",
      "partnerBirthPlace": "साथी का जन्म शहर / स्थान (वैकल्पिक — चंद्र व चंद्र-बल खोलता है)",
      "partnerBirthPlacePlaceholder": "जैसे: नई दिल्ली, भारत",
      "partnerBirthPlaceHint": "लेवल २ — वही ऑफ़लाइन एटलस जो आपके अपने जन्मस्थान के लिए है (७,०००+ भारतीय कस्बे तथा चयनित विश्व शहर)। नाम के कुछ अक्षर लिखें या “28.41, 77.32” जैसे निर्देशांक भरें। कुछ भी कहीं नहीं भेजा जाता।",
      "partnerTierNote": "साथी के समय व स्थान के बिना भी रिपोर्ट पूरा मूलांक / भाग्यांक मिलान (लेवल १) देती है और स्पष्ट लिखती है कि चंद्र-बल की गणना नहीं हुई — अनुमान कभी नहीं लगाया जाता।",
      ...
      "errLegalName": "कृपया कानूनी नाम जाँचें — अक्षर आवश्यक हैं।",
      "errDob": "कृपया दिन-माह-वर्ष (dd-mm-yyyy) क्रम में मान्य जन्म तिथि दर्ज करें, जैसे 05-08-1976।",
      ...
      "navSummary": "सारांश",
      "moduleNavigation": "रिपोर्ट मॉड्यूल",
      "moduleQuickNavigation": "मॉड्यूल नेविगेशन",
      "tabFoundation": "Foundation · लो शू",
      "tabTimeline": "समय-रेखा · अंक-ज्योतिष दशा",
      "tabCockpit": "कॉकपिट · प्रैक्टिशनर",
      "navCockpit": "कॉकपिट",
      "cockpitPanelTitle": "आपका एक-पृष्ठ क्लिनिकल कॉकपिट",
      "cockpitPanelDesc": "एक ही प्रिंट-योग्य परामर्श शीट: पहचान, दोनों ग्रिड, शास्त्रीय संबंध से आंका गया सक्रिय दशा-क्रम, ट्राइएज किया गया उपाय और श्रेणीबद्ध घटना-विंडो। यह कुछ नया गणना नहीं करता — केवल संक्षेप करता है।",
      "navFoundation": "Foundation",
      "navTimeline": "समय-रेखा",
      "navLoShu": "लो शू ब्लूप्रिंट",
      "timelineNavigation": "समय-रेखा नेविगेशन",
      "backToTimeline": "समय-रेखा शीर्ष",
      "foundationPanelTitle": "आपका मनोवैज्ञानिक ब्लूप्रिंट और अभ्यास",
      "foundationPanelDesc": "क्लासिक लो शू जन्म, नाम और संयुक्त ग्रिड से पैटर्न समझें, फिर अपना व्यावहारिक ४०-दिवसीय activation plan बनाएं।",
      "timelinePanelTitle": "आपका दशा रोडमैप",
      "timelinePanelDesc": "वर्तमान अंक-ज्योतिष दशा-क्रम, सक्रिय वास्तु क्षेत्र और जीवन-घटना विंडो को समय-आधारित रोडमैप की तरह पढ़ें। यह अनुपातिक numerology clock शास्त्रीय विम्शोत्तरी नहीं है और समय बदलने के लिए किसी भी ग्रिड का उपयोग नहीं करता।",
      "navProfile": "प्रोफाइल",
      ...
      "clinicalNoticeTitle": "नैतिक एवं स्वास्थ्य सूचना",
      "clinicalNoticeBody": "अंक ज्योतिष, वैदिक दशा समय-रेखाएं और तत्व संतुलन सुझाव पारंपरिक व्याख्या-ढांचे हैं — व्यक्तिगत चिंतन और जीवनशैली सामंजस्य के लिए। ये चिकित्सीय, मानसिक, कानूनी या वित्तीय निदान नहीं हैं। नए उपवास, जड़ी-बूटी दिनचर्या या तीव्र श्वास अभ्यास शुरू करने से पहले योग्य चिकित्सक से परामर्श अवश्य करें।",
      "sadhanaTitle": "अभ्यास गहराई — स्केल्ड साधना",
      "sadhanaDesc": "जितनी दैनिक क्षमता आप वास्तव में निभा सकें, उतनी गहराई चुनें। यह पैमाना केवल अभ्यास का आकार तय करता है — लो शू उपाय लक्ष्य नहीं बदलता और किसी सुरक्षा सीमा को ओवरराइड नहीं करता।",
      "sadhanaBeginnerTitle": "शुरुआती · मिनिमलिस्ट / कॉर्पोरेट",
      "sadhanaBeginnerDesc": "११ बार छोटा मंत्र या ११ बार संकल्प पत्र · ५ मिनट श्वास अभ्यास · रंग संकेत · रोज दिखने वाली एक जगह की सफाई",
      "sadhanaIntermediateTitle": "मध्यम · प्रैक्टिशनर / साधक",
      "sadhanaIntermediateDesc": "२७ बार जप (चौथाई माला) समर्पित माला पर · power day पर औषधि स्नान · साप्ताहिक power-day दान",
      "sadhanaClassicalTitle": "शास्त्रीय · पूर्ण साधना",
      "sadhanaClassicalDesc": "१०८ बार जप (पूरी माला) समर्पित माला पर · पूर्ण औषधि स्नान · साप्ताहिक power-day दान",
      "sadhanaHint": "डिफ़ॉल्ट: प्रैक्टिशनर / साधक डोज़। इसे कभी भी Edit Details में बदल सकते हैं।",
      "sadhanaSummaryLabel": "अभ्यास गहराई",
      "sadhanaCardTitle": "आपकी स्केल्ड साधना — अभ्यास गहराई",
      "sadhanaCardDesc": "आपकी चुनी हुई अभ्यास गहराई। यह केवल दैनिक अभ्यास का आकार तय करती है — लो शू लक्ष्य, ट्राइएज टियर और हर सुरक्षा सीमा यथावत रहती है।",
      "sadhanaRowJapa": "जप / संकल्प डोज़",
      "sadhanaRowMala": "माला",
      "sadhanaRowBreath": "श्वास अभ्यास",
      "sadhanaRowSnan": "औषधि स्नान",
      "sadhanaRowCharity": "दान की आवृत्ति",
      "sadhanaRowSpace": "जगह",
      "sadhanaJapaBeginner": "रोज ११ बार छोटा मंत्र। जप संभव न हो उस दिन संकल्प पत्र ११ बार लिखें।",
      "sadhanaJapaIntermediate": "रोज २७ बार (चौथाई माला) — वही बीज या छोटा मंत्र जो Remedy Triage कार्ड में दिया है।",
      "sadhanaJapaClassical": "रोज १०८ बार (पूरी माला) — पूर्ण शास्त्रीय गिनती।",
      "sadhanaJapaHeld": "इस चक्र Remedy Triage द्वारा होल्ड; लक्ष्य सक्रिय होते ही यह डोज़ शुरू होगा।",
      "sadhanaMalaDedicated": "एक समर्पित माला, केवल इस जप के लिए रखी गई।",
      "sadhanaMalaOptional": "मिनिमलिस्ट ट्रैक में माला आवश्यक नहीं — ११ बार उंगलियों पर गिनें।",
      "sadhanaBreathBeginner": "५ मिनट सहज श्वास अभ्यास — धीमा, समान श्वास, कुंभक नहीं।",
      "sadhanaBreathIntermediate": "खंड 4A के श्वास अभ्यास १० मिनट — जप से पहले या बाद।",
      "sadhanaBreathClassical": "औषधि स्नान के बाद खंड 4A का पूरा श्वास अभ्यास २० मिनट।",
      "sadhanaBreathSub": "श्वास रोकनी पड़े या चक्कर आए तो तुरंत रोकें और सामान्य श्वास पर लौटें।",
      "sadhanaSnanBeginner": "अपने रंग संकेत के साथ जल्दी स्नान; सरल और नियमित रखें।",
      "sadhanaSnanIntermediate": "अपने power day पर पूर्ण औषधि स्नान (खंड 4A रूप)।",
      "sadhanaSnanClassical": "हर अभ्यास दिवस पर पूर्ण औषधि स्नान (खंड 4A रूप)।",
      "sadhanaCharityBeginner": "मासिक, या सुविधा हो तो power day पर — एक कार्य पर्याप्त है।",
      "sadhanaCharityPractitioner": "साप्ताहिक, अपने power day पर (योजना की मूलांक / भाग्यांक तालिका)।",
      "sadhanaSpaceBeginner": "रोज दिखने वाली एक जगह खाली करें; हर सप्ताह एक सतह व्यवस्थित करें।",
      "sadhanaSpacePractitioner": "सक्रिय क्षेत्र को हर सप्ताह क्लटर-मुक्त रखें (Timeline देखें)।",
      "sadhanaScaleNote": "यह पैमाना अभ्यास का आकार तय करता है; लो शू उपाय लक्ष्य नहीं बदलता, और हर सुरक्षा सीमा डोज़ को सीमित रखती है (चंद्र-शीत उष्ण रूप, दोष × ग्रह मृदु रूप, सौर-भार संयम, १८ से कम आयु में रत्न स्थगन)।",
      "sadhanaIntenseNotice": "शास्त्रीय गहराई तीव्र श्वास अभ्यास और औषधि स्नान जोड़ती है — पहले योग्य चिकित्सक से परामर्श करें (Northstar Summary की नैतिक एवं स्वास्थ्य सूचना देखें)।",
      "sadhanaMinorNote": "१८ से कम आयु: यह अभ्यास माता-पिता या अभिभावक की देखरेख में हो, और श्वास अभ्यास कोमल रहे — श्वास रोकने वाला कुंभक न करें।",
      "sadhanaEditHint": "इसे कभी भी Edit Details → Practice Depth में बदलें।",
      "sadhanaDoseBeginner": "रोज ११ बार (छोटा मंत्र — जप संभव न हो तो संकल्प पत्र लिखें), एक ही समय पर",
      "sadhanaDoseIntermediate": "रोज २७ बार (चौथाई माला), एक ही समय पर",
      "sadhanaDoseClassical": "रोज १०८ बार (पूरी माला), एक ही समय पर",
      "sadhanaDeepenBeginner": "डोज़ सहज लगे तभी गहराएं: सूर्योदय मंत्र जाप २७ बार (चौथाई माला) तक बढ़ाएं और अनुभव लिखें।",
      "sadhanaDeepenIntermediate": "साधना को गहरा करें: सूर्योदय मंत्र जाप १०८ बार (पूरी माला) करें और अनुभव लिखें।",
      "sadhanaDeepenClassical": "आप पूर्ण शास्त्रीय गिनती पर हैं: १०८ बार जप स्थिर रखें और power day पर अपना अनुभव लिखें।",
      "secProfile": "मुख्य अंकशास्त्र प्रोफाइल",
      "secTraits": "आपका मूल स्वभाव — खूबियां, कमजोरियां और सुधार",
      "secVedicGrid": "वैदिक जन्म ग्रिड — ग्रह-शक्ति संकेतक",
      "secLoShuGrid": "लो शू ब्लूप्रिंट — आपका Foundation",
      "secVedicCompare": "उन्नत वैदिक तुलना",
      "secWeak": "लो शू उपाय किट",
      "secTattva": "वैदिक तल सामंजस्य — तत्व संतुलन",
      "secTattvaDesc": "न्यून जन्म-तलों को स्थिर करने के लिए शारीरिक, श्वास और औषधि आधार। ये आपकी ४०-दिवसीय लो शू साधना के साथ चलते हैं, बिना अतिरिक्त अनुष्ठान थकान के।",
      "secZodiac": "वैदिक सूर्य राशि संदर्भ — {sign}",
      ...
      "secTiming": "दीर्घकालीन व्यक्तिगत-वर्ष संदर्भ",
      "secDasha": "दशा समय-रेखा — जीवन-घटना विंडो",
      "fieldModeOn": "क्षेत्र मोड",
      "fieldModeOff": "क्षेत्र मोड बंद करें",
      "fieldModeToggle": "क्षेत्र पठन मोड चालू/बंद करें",
      "fieldModeOnToast": "क्षेत्र मोड चालू — बड़ा अक्षर, एक स्तंभ, कम विकर्षण।",
      "fieldModeOffToast": "क्षेत्र मोड बंद।",
      "vimshottariTitle": "शास्त्रीय विम्शोत्तरी दशा — चंद्र-नक्षत्र आधारित",
      "vimshottariKicker": "वैदिक · नक्षत्र-आधारित · निश्चित १२०-वर्षीय चक्र",
      "vimshottariIntro": "यह शास्त्रीय वैदिक विम्शोत्तरी क्रम है: इसका आधार जन्म के समय चंद्रमा का नक्षत्र है और इसमें ग्रहों की निश्चित अवधियाँ हैं (केतु ७, शुक्र २०, सूर्य ६, चंद्र १०, मंगल ७, राहु १८, गुरु १६, शनि १९, बुध १७ वर्ष)। यह आपकी चंद्र-स्थिति से गणना होता है, मूलांक से नहीं, और अंक-ज्योतिष दशा रोडमैप से स्वतंत्र रूप से चलता है।",
      "vimshottariAnchorLabel": "आधार",
      "vimshottariBalanceLabel": "जन्म के समय जन्म-ग्रह की शेष अवधि",
      "vimshottariBalanceNote": "हर नक्षत्र १३°२०′ का होता है। आप उसके बीच में जन्मे थे, इसलिए नक्षत्र का जो भाग बीत चुका है वह प्रारंभिक ग्रह की अवधि से घटा दिया जाता है और शेष वर्ष आगे चलते हैं।",
      "vimshottariLadderTitle": "महादशा क्रम (निश्चित १२०-वर्षीय चक्र)",
      "vimshottariCurrentTitle": "वर्तमान विम्शोत्तरी क्रम",
      "vimshottariCompareTitle": "यह अंक-ज्योतिष रोडमैप से भिन्न क्यों है",
      "vimshottariCompareAgree": "दोनों गणनाएँ इस समय एक ही स्वामी ग्रह पर सहमत हैं। यह इन विशेष आधारों का संयोग है, कोई नियम नहीं — दोनों पद्धतियाँ स्वतंत्र रहती हैं।",
      "vimshottariCompareDiffer": "यहाँ दोनों गणनाएँ भिन्न हैं, और यह अपेक्षित है — कोई त्रुटि नहीं। अंक-ज्योतिष रोडमैप आपके मूलांक से ४५-वर्षीय आनुपातिक आधार पर बनता है; विम्शोत्तरी क्रम आपके चंद्र-नक्षत्र पर शास्त्रीय १२०-वर्षीय आधार पर टिका है। कोई दूसरे को अधिक्रमित नहीं करता — इन्हें दो अलग वैदिक परंपराओं की तरह पढ़ें, जैसे कोई ज्योतिषी और कोई अंक-ज्योतिषी अपने-अपने शास्त्र से अलग बताएँगे।",
      "vimshottariNoTime": "शास्त्रीय विम्शोत्तरी क्रम के लिए आपका सटीक जन्म समय और मान्य जन्मस्थान आवश्यक है, क्योंकि इसका आधार चंद्र का नक्षत्र है, केवल जन्म तिथि नहीं। इसे पाने के लिए जन्म समय और स्थान भरें।",
      "vimshottariAge": "आयु",
      "vimshottariBalanceTag": "जन्म से शेष अवधि",
      "vimshottariMD": "महादशा",
      "vimshottariAD": "अंतर्दशा",
      "vimshottariPD": "प्रत्यंतर",
      "vimshottariElapsed": "बीत चुका",
      "vimshottariBoundary": "यह मॉड्यूल लो शू उपायों, वास्तु क्षेत्रों या अंक-ज्योतिष घटना-विंडो को कभी नहीं बदलता। यह एक स्वतंत्र शास्त्रीय पठन है।",
      "dashaJudgeNote": "ऊपर का रोडमैप हमारी आनुपातिक अंक-ज्योतिष गणना है (महादशा × अंतर्दशा ÷ ४५): प्रत्येक महादशा ठीक अपने अंक जितने वर्ष चलती है और हर उप-काल ग्रह के भार के अनुपात में बँटता है, जिससे महादशा, अंतर्दशा और प्रत्यंतर तीनों स्तर सटीक रूप से एक-दूसरे में बैठते हैं। यह शास्त्रीय विम्शोत्तरी दशा <strong>नहीं</strong> है और नक्षत्र-आधारित कोई दावा नहीं करती — इसी अनुभाग का अलग <em>शास्त्रीय विम्शोत्तरी</em> कार्ड ही वास्तविक नक्षत्र-आधारित क्रम है, और दोनों का भिन्न होना स्वीकार्य है। <em>वैकल्पिक पद्धति:</em> कुछ आधुनिक अंकशास्त्री अंतर्दशा को जन्मदिन-से-जन्मदिन के ठीक १-वर्ष खंड मानते हैं; दोनों विद्यालय प्रचलित हैं, तिथियां थोड़ी भिन्न आ सकती हैं। घटना-विंडो केवल सक्रिय महादशा-अंतर्दशा के कारक ग्रहों से बनती है; लो शू और वैदिक जन्म-ग्रिड इन्हें नहीं बदलते।",
      "dashaLadderNote": "यह सीढ़ी ८०-वर्षीय औसत-आयु सीमा से आगे तक गणना होती है ताकि हर जीवन-घटना पट्टी — धन व व्यापार सहित ७५ तक — जीवन-भर आवृत रहे।",
      "dashaCoverageNote": "कवरेज: धन व व्यापार विंडो २१–७५ आयु तक देखी जाती हैं, और हर दशा-सीमा ८०-वर्षीय औसत आयु मानती है। शास्त्रीय पट्टी बंद होने पर देर-विंडो ८० आयु तक (या १५ वर्ष आगे, जो अधिक हो) देखी जाती हैं, कार्ड खाली नहीं छोड़ा जाता।",
    ...
    "numbers": {
      "1": {
        ...
        "wearGuidance": "सुनहरा, केसरिया या हल्का पीला",
        "metal": "सोना / तांबा",
  ...
  "gu": {
    ...
    "ui": {
      "brandName": "NumeroVastu 360",
      "brandSub": "લો શુ Foundation અને અંક-જ્યોતિષ દશા",
      ...
      "reportHeroMeta": "જન્મ તારીખ: <strong>{dob}</strong>{birthLine} · મુખ્ય લક્ષ્ય: {goals}",
      "reportGenLine": "રિપોર્ટ બનાવ્યું {date} · તમારા ઉપકરણ પર સ્થાનિક ગણતરી — કંઈ પણ તમારા બ્રાઉઝર બહાર જતું નથી",
      "readingGuideTitle": "આ રિપોર્ટ કેવી રીતે વાંચવો",
      "readingGuideDriver": "<strong>ડ્રાઇવર (મૂલાંક)</strong> — તમારું મન, વ્યક્તિત્વ અને રોજિંદી ઊર્જા; <strong>કન્ડક્ટર (ભાગ્યાંક)</strong> — તમારો ભાગ્ય-માર્ગ. બંને તમારી જન્મતારીખ પરથી બને છે.",
      "readingGuideGrid": "<strong>લો શુ ગ્રિડ</strong> — નવ અંક-ઊર્જાઓ (1–9, દરેકનો સ્વામી એક ગ્રહ) માંથી કઈ તમારી જન્મતારીખ અને નામમાં હાજર, પુનરાવૃત કે ખૂટતી છે. વિભાગ {grid} દરેક ખાલી અંક વાંચે છે: પહેલી ખાલી જગ્યાઓને વિભાગ {kits} માં સંપૂર્ણ ઉપાય કિટ મળે છે, બાકીને ઝડપી સંતુલનકારક, અને Remedy Triage એક સમયે એક જ તીવ્ર લક્ષ્ય રાખે છે.",
      "readingGuideFlow": "ક્રમાંકિત વિભાગો ઓળખ → ઉપાય → સમય → વાસ્તુ ક્રમમાં Foundation, Timeline અને Cockpit ટેબમાં બને છે. Foundation ના અંતે <strong>40-દિવસની સક્રિયકરણ યોજના</strong> તમારો પ્રારંભ-બિંદુ છે — તેને 40 દિવસ સતત કરો.",
      "reportClosingBrand": "NumeroVastu 360 — ખાનગી રિપોર્ટ",
      "reportClosingDisclaimer": "શાસ્ત્રીય વૈદિક અંકશાસ્ત્ર અને વાસ્તુ સિદ્ધાંતો પર આધારિત માર્ગદર્શન — સહાયક પ્રથાઓ, વ્યાવસાયિક તબીબી, કાનૂની કે નાણાકીય સલાહનો વિકલ્પ નથી.",
      "born": "જન્મ",
      "statusPrivate": "ખાનગી અને સુરક્ષિત",
      "statusKnowledge": "જ્ઞાન સંગ્રહ v{ver}",
      "statusApp": "એપ v2.15.0 · ઓન-ડિવાઇસ એન્જિન",
      "statusBuild": "આવૃત્તિ 2026-09-08",
      ...
      "introDesc": "તમારી વિગતો એક જ વાર દાખલ કરો. અમે તમારી ક્લાસિક લો શુ Foundation (જન્મ, નામ અને સંયુક્ત ગ્રિડ) બનાવીએ છીએ, મૂળાંક-ભાગ્યાંક ગણીએ છીએ, અને અલગ અંક-જ્યોતિષ દશા સમયરેખા તથા સક્રિય વાસ્તુ ક્ષેત્ર બતાવીએ છીએ — બધું તમારા ડિવાઇસ પર ખાનગી રીતે. આ પ્રમાણસર numerology clock શાસ્ત્રીય વિમ્શોત્તરી દશા નથી.",
      ...
      "fullName": "દૈનિક / વ્યાવસાયિક નામ",
      "fullNamePlaceholder": "જે નામ તમે દૈનિક વાપરો છો, જેમ કે: અમર કે. સંભવાની",
      "fullNameHint": "જે નામ દુનિયા વાપરે છે — વિઝિટિંગ કાર્ડ, ઈમેલ સહી, બેંક કાર્ડ, LinkedIn. આ જ તમારો મુખ્ય નામાંક નક્કી કરે છે.",
      "legalName": "આખું કાનૂની નામ (આધાર / PAN પ્રમાણે)",
      "legalNameOptional": "(વૈકલ્પિક — પણ સૌથી શક્તિશાળી નામ-ઉપાય ખોલે છે)",
      "legalNamePlaceholder": "જેમ કે: અમરકુમાર કિશોરભાઈ સંભવાની",
      "legalNameHint": "સરકારી રેકોર્ડ પર લખેલું બરાબર એ જ નામ. તેનું મધ્ય નામ / પિતૃ-નામ (કિશોરભાઈ → K) એન્જિનને તમારો સાચો કૌટુંબિક આદ્યાક્ષર આપે છે — કોઈ બનાવટી અક્ષર કદી ઉમેરાતો નથી.",
      "dob": "જન્મ તારીખ (Date of Birth)",
      "dobPlaceholder": "દિન-માસ-વર્ષ e.g. 05-08-1976",
      "dobHint": "દિન-માસ-વર્ષ ક્રમમાં, જેમ કે 05-08-1976.",
      ...
      "healthTagsLabel": "સ્વાસ્થ્ય વિગતો (મરજિયાત)",
      "healthTagsHint": "મરજિયાત — ચંદ્ર ઉપાયોની સલામતી નક્કી કરે છે. એલર્જી / શ્વસન / શરદી પસંદ કરવાથી ચંદ્ર કિટ ઉષ્ણ રૂપે ચાલે છે.",
      "healthTagRespiratory": "એલર્જી / શ્વસન / શરદી",
      "healthTagHeat": "એસિડિટી / સોજો / ગરમી",
      "healthTagFatigue": "સાંધા / પાચન / થાક",
      ...
      "birthPlaceHint": "લેવલ ૨ — ૭,૦૦૦+ ભારતીય કસ્બા અને ૬૩૦ પસંદગીના વિશ્વ શહેરો, સંપૂર્ણ ઑફલાઇન. નામ લખો, અક્ષાંશ/રેખાંશ ભરો, અથવા Photonથી એક વાર શોધો (તમારી પસંદ).",
      "photonLookup": "ઑનલાઇન શોધો (Photon)",
      "loadGulfAtlas": "ગલ્ફ શહેરો લોડ કરો (ઑફલાઇન)",
      "loadWorldAtlas": "વિશ્વ શહેરો 1 લાખ+ લોડ કરો (ઑફલાઇન)",
      "photonHint": "Photon વૈકલ્પિક છે: માત્ર તમે લખેલું સ્થળ-નામ photon.komoot.io પર જાય છે. પસંદ કરેલું શહેર-નામ સ્થાનિક રીતે સાચવાય છે — અક્ષાંશ કે કુંડળી નહીં.",
      "photonNeedQuery": "પહેલાં શહેરનું નામ લખો, પછી શોધો.",
      "photonNoResults": "Photon પર મેળ ન મળ્યો. નજીકનું જિલ્લું અજમાવો અથવા અક્ષાંશ/રેખાંશ લખો.",
      "photonError": "Photon શોધ નિષ્ફળ. ઑફલાઇન રહો અથવા અક્ષાંશ/રેખાંશ લખો.",
      "atlasLoaded": "ઑફલાઇન એટલાસ લોડ થયો.",
      "atlasAlreadyLoaded": "આ એટલાસ પહેલેથી લોડ છે.",
      "atlasLoadError": "એટલાસ ભાગ લોડ ન થયો.",
      "birthGeoManual": "મેન્યુઅલ અક્ષાંશ/રેખાંશ (વૈકલ્પિક)",
      "birthLat": "અક્ષાંશ",
      "birthLon": "રેખાંશ",
      "birthTz": "સમય ક્ષેત્ર (UTCથી કલાક)",
      "birthGeoManualHint": "જ્યારે સ્થળ ખબર હોય ત્યારે એટલાસને ઓવરરાઇડ કરે છે. ખાલી છોડો તો સમય ક્ષેત્ર +5.5 ગણાય. 25 કિમીની અંદરનું જિલ્લું (લગ્ન ફેર 0.1°થી ઓછો) નામ ન મળે ત્યારે વપરાય છે.",
      ...
      "partnerBirthTime": "સાથીદારનો ચોક્કસ જન્મ સમય (મરજિયાત — ચંદ્ર અને ચંદ્ર-બલ ખોલે છે)",
      "partnerBirthTimeHint": "લેવલ ૨ — ચંદ્ર રોજ આશરે ૧૩°૨૦′ ચાલે છે, તેથી ચોક્કસ સમય વિના સાથીદારની ચંદ્ર રાશિ અને નક્ષત્ર નક્કી થઈ શકતાં નથી. ખાલી રાખો તો રિપોર્ટ બપોરનો જન્મ માની લેવાને બદલે સ્પષ્ટ કહે છે કે ગણતરી થઈ નથી.",
      "partnerBirthPlace": "સાથીદારનું જન્મ શહેર / સ્થળ (મરજિયાત — ચંદ્ર અને ચંદ્ર-બલ ખોલે છે)",
      "partnerBirthPlacePlaceholder": "જેમ કે: અમદાવાદ, ભારત",
      "partnerBirthPlaceHint": "લેવલ ૨ — તમારા પોતાના જન્મસ્થળ માટે વપરાતો એ જ ઑફલાઇન ઍટલસ (૭,૦૦૦+ ભારતીય કસ્બા તથા પસંદગીના વિશ્વ શહેરો). નામના થોડા અક્ષર લખો અથવા “28.41, 77.32” જેવા અક્ષાંશ/રેખાંશ ભરો. કશું ક્યાંય મોકલાતું નથી.",
      "partnerTierNote": "સાથીદારના સમય અને સ્થળ વિના પણ રિપોર્ટ સંપૂર્ણ મૂળાંક / ભાગ્યાંક સરખામણી (લેવલ ૧) આપે છે અને સ્પષ્ટ લખે છે કે ચંદ્ર-બલ ગણાયું નથી — અનુમાન ક્યારેય કરાતું નથી.",
      ...
      "errLegalName": "કૃપા કરીને કાનૂની નામ તપાસો — અક્ષરો જરૂરી છે.",
      "errDob": "કૃપા કરીને દિન-માસ-વર્ષ (dd-mm-yyyy) ક્રમમાં સાચી જન્મ તારીખ દાખલ કરો, જેમ કે 05-08-1976.",
      ...
      "navSummary": "સારાંશ",
      "moduleNavigation": "રિપોર્ટ મોડ્યુલ",
      "moduleQuickNavigation": "મોડ્યુલ નેવિગેશન",
      "tabFoundation": "Foundation · લો શુ",
      "tabTimeline": "સમયરેખા · અંક-જ્યોતિષ દશા",
      "tabCockpit": "કોકપિટ · પ્રેક્ટિશનર",
      "navCockpit": "કોકપિટ",
      "cockpitPanelTitle": "તમારું એક-પાનાનું ક્લિનિકલ કોકપિટ",
      "cockpitPanelDesc": "એક જ પ્રિન્ટ કરી શકાય તેવી પરામર્શ શીટ: ઓળખ, બંને ગ્રિડ, શાસ્ત્રીય સંબંધથી મૂલવાયેલો સક્રિય દશા-ક્રમ, ટ્રાયએજ કરેલો ઉપાય અને શ્રેણીબદ્ધ ઘટના-વિન્ડો. તે નવું કંઈ ગણતું નથી — માત્ર સંક્ષેપ કરે છે.",
      "navFoundation": "Foundation",
      "navTimeline": "સમયરેખા",
      "navLoShu": "લો શુ બ્લૂપ્રિન્ટ",
      "timelineNavigation": "સમયરેખા નેવિગેશન",
      "backToTimeline": "સમયરેખા ટોચ",
      "foundationPanelTitle": "તમારો મનોવૈજ્ઞાનિક બ્લૂપ્રિન્ટ અને અભ્યાસ",
      "foundationPanelDesc": "ક્લાસિક લો શુ જન્મ, નામ અને સંયુક્ત ગ્રિડથી પેટર્ન સમજો, પછી તમારો વ્યવહારુ ૪૦-દિવસનો activation plan બનાવો.",
      "timelinePanelTitle": "તમારો દશા રોડમેપ",
      "timelinePanelDesc": "વર્તમાન અંક-જ્યોતિષ દશા-ક્રમ, સક્રિય વાસ્તુ ક્ષેત્ર અને જીવન-ઘટના વિન્ડોને સમય-આધારિત રોડમેપ તરીકે વાંચો. આ પ્રમાણસર numerology clock શાસ્ત્રીય વિમ્શોત્તરી નથી અને સમય બદલવા માટે કોઈ પણ ગ્રિડનો ઉપયોગ કરતો નથી.",
      "navProfile": "પ્રોફાઇલ",
      ...
      "clinicalNoticeTitle": "નૈતિક અને આરોગ્ય સૂચના",
      "clinicalNoticeBody": "અંકજ્યોતિષ, વૈદિક દશા સમયરેખાઓ અને તત્વ સંતુલન સૂચનો પરંપરાગત અર્થઘટનના માળખા છે — વ્યક્તિગત ચિંતન અને જીવનશૈલી સુસંગતતા માટે. તે ચિકિત્સા, માનસિક, કાનૂની કે નાણાકીય નિદાન નથી. નવા ઉપવાસ, જડીબુટ્ટી દિનચર્યા કે તીવ્ર શ્વાસ અભ્યાસ શરૂ કરતાં પહેલાં યોગ્ય તબીબની સલાહ લેવી.",
      "sadhanaTitle": "અભ્યાસ ઊંડાણ — સ્કેલ્ડ સાધના",
      "sadhanaDesc": "તમે ખરેખર નિભાવી શકો એટલી દૈનિક ક્ષમતા પ્રમાણે ઊંડાણ પસંદ કરો. આ પ્રમાણ ફક્ત અભ્યાસનું આકાર નક્કી કરે છે — લો શુ ઉપાય લક્ષ્ય બદલતું નથી અને કોઈ સલામતી મર્યાદા ઓવરરાઇડ કરતું નથી.",
      "sadhanaBeginnerTitle": "શરૂઆતનું સ્તર · મિનિમલિસ્ટ / કોર્પોરેટ",
      "sadhanaBeginnerDesc": "૧૧ વખત ટૂંકો મંત્ર કે ૧૧ વખત સંકલ્પ પત્ર · ૫ મિનિટ શ્વાસ અભ્યાસ · રંગ સંકેત · રોજ દેખાતી એક જગ્યાની સફાઈ",
      "sadhanaIntermediateTitle": "મધ્યમ · પ્રેક્ટિશનર / સાધક",
      "sadhanaIntermediateDesc": "૨૭ વખત જાપ (ચોથા ભાગની માળા) સમર્પિત માળા પર · power day પર ઔષધિ સ્નાન · સાપ્તાહિક power-day દાન",
      "sadhanaClassicalTitle": "શાસ્ત્રીય · પૂર્ણ સાધના",
      "sadhanaClassicalDesc": "૧૦૮ વખત જાપ (પૂરી માળા) સમર્પિત માળા પર · પૂર્ણ ઔષધિ સ્નાન · સાપ્તાહિક power-day દાન",
      "sadhanaHint": "ડિફોલ્ટ: પ્રેક્ટિશનર / સાધક ડોઝ. Edit Details માંથી ક્યારેય પણ બદલી શકાય છે.",
      "sadhanaSummaryLabel": "અભ્યાસ ઊંડાણ",
      "sadhanaCardTitle": "તમારી સ્કેલ્ડ સાધના — અભ્યાસ ઊંડાણ",
      "sadhanaCardDesc": "તમે પસંદ કરેલું અભ્યાસ ઊંડાણ. તે ફક્ત દૈનિક અભ્યાસનું આકાર નક્કી કરે છે — લો શુ લક્ષ્ય, ટ્રાયએજ ટિયર અને દરેક સલામતી મર્યાદા યથાવત્ રહે છે.",
      "sadhanaRowJapa": "જાપ / સંકલ્પ ડોઝ",
      "sadhanaRowMala": "માળા",
      "sadhanaRowBreath": "શ્વાસ અભ્યાસ",
      "sadhanaRowSnan": "ઔષધિ સ્નાન",
      "sadhanaRowCharity": "દાનની આવૃત્તિ",
      "sadhanaRowSpace": "જગ્યા",
      "sadhanaJapaBeginner": "રોજ ૧૧ વખત ટૂંકો મંત્ર. જાપ શક્ય ન હોય તે દિવસે સંકલ્પ પત્ર ૧૧ વખત લખો.",
      "sadhanaJapaIntermediate": "રોજ ૨૭ વખત (ચોથા ભાગની માળા) — Remedy Triage કાર્ડમાં આપેલો બીજ કે ટૂંકો મંત્ર.",
      "sadhanaJapaClassical": "રોજ ૧૦૮ વખત (પૂરી માળા) — પૂરી શાસ્ત્રીય ગણતરી.",
      "sadhanaJapaHeld": "આ ચક્રે Remedy Triage દ્વારા હોલ્ડ; લક્ષ્ય સક્રિય થતાં આ ડોઝ શરૂ થશે.",
      "sadhanaMalaDedicated": "એક સમર્પિત માળા, ફક્ત આ જાપ માટે રાખેલી.",
      "sadhanaMalaOptional": "મિનિમલિસ્ટ ટ્રેકમાં માળા જરૂરી નથી — ૧૧ વખત આંગળી પર ગણો.",
      "sadhanaBreathBeginner": "૫ મિનિટ સહજ શ્વાસ અભ્યાસ — ધીમો, સમાન શ્વાસ, કુંભક નહીં.",
      "sadhanaBreathIntermediate": "વિભાગ 4A ના શ્વાસ અભ્યાસ ૧૦ મિનિટ — જાપ પહેલાં કે પછી.",
      "sadhanaBreathClassical": "ઔષધિ સ્નાન પછી વિભાગ 4A નો પૂરો શ્વાસ અભ્યાસ ૨૦ મિનિટ.",
      "sadhanaBreathSub": "શ્વાસ રોકવો પડે કે ચક્કર આવે તો તરત અટકો અને સામાન્ય શ્વાસ પર પાછા ફરો.",
      "sadhanaSnanBeginner": "તમારા રંગ સંકેત સાથે ઝડપી સ્નાન; સરળ અને નિયમિત રાખો.",
      "sadhanaSnanIntermediate": "તમારા power day પર પૂર્ણ ઔષધિ સ્નાન (વિભાગ 4A રૂપ).",
      "sadhanaSnanClassical": "દરેક અભ્યાસ દિવસે પૂર્ણ ઔષધિ સ્નાન (વિભાગ 4A રૂપ).",
      "sadhanaCharityBeginner": "માસિક, અથવા અનુકૂળ હોય ત્યારે power day પર — એક કાર્ય પૂરતું છે.",
      "sadhanaCharityPractitioner": "સાપ્તાહિક, તમારા power day પર (યોજનાનું મૂળાંક / ભાગ્યાંક કોષ્ટક).",
      "sadhanaSpaceBeginner": "રોજ દેખાતી એક જગ્યા ખાલી કરો; દર અઠવાડિયે એક સપાટી ગોઠવો.",
      "sadhanaSpacePractitioner": "સક્રિય ક્ષેત્ર દર અઠવાડિયે ક્લટર-મુક્ત રાખો (Timeline જુઓ).",
      "sadhanaScaleNote": "આ પ્રમાણ અભ્યાસનું આકાર નક્કી કરે છે; લો શુ ઉપાય લક્ષ્ય બદલાતું નથી, અને દરેક સલામતી મર્યાદા ડોઝને મર્યાદિત રાખે છે (ચંદ્ર-શીત ઉષ્ણ રૂપ, દોષ × ગ્રહ મૃદુ રૂપ, સૌર-ભાર સંયમ, ૧૮ થી ઓછી ઉંમરે રત્ન મુલતવી).",
      "sadhanaIntenseNotice": "શાસ્ત્રીય ઊંડાણ તીવ્ર શ્વાસ અભ્યાસ અને ઔષધિ સ્નાન ઉમેરે છે — પહેલાં યોગ્ય તબીબની સલાહ લો (Northstar Summary ની નૈતિક અને આરોગ્ય સૂચના જુઓ).",
      "sadhanaMinorNote": "૧૮ થી ઓછી ઉંમર: આ અભ્યાસ માતા-પિતા કે વાલીની દેખરેખમાં થાય, અને શ્વાસ અભ્યાસ નરમ રહે — શ્વાસ રોકવાનો કુંભક ન કરો.",
      "sadhanaEditHint": "Edit Details → Practice Depth માંથી ક્યારેય પણ બદલો.",
      "sadhanaDoseBeginner": "રોજ ૧૧ વખત (ટૂંકો મંત્ર — જાપ શક્ય ન હોય તો સંકલ્પ પત્ર લખો), એક જ સમયે",
      "sadhanaDoseIntermediate": "રોજ ૨૭ વખત (ચોથા ભાગની માળા), એક જ સમયે",
      "sadhanaDoseClassical": "રોજ ૧૦૮ વખત (પૂરી માળા), એક જ સમયે",
      "sadhanaDeepenBeginner": "ડોઝ સ્થિર લાગે તો જ ઊંડો કરો: સૂર્યોદય મંત્ર જાપ ૨૭ વખત (ચોથા ભાગની માળા) સુધી વધારો અને અનુભવ લખો.",
      "sadhanaDeepenIntermediate": "અભ્યાસ ઊંડો કરો: સૂર્યોદય મંત્ર જાપ ૧૦૮ વખત (પૂરી માળા) કરો અને અનુભવ લખો.",
      "sadhanaDeepenClassical": "તમે પૂરી શાસ્ત્રીય ગણતરી પર છો: ૧૦૮ વખતનો જાપ સ્થિર રાખો અને power day પર અનુભવ લખો.",
      "secProfile": "મુખ્ય અંકશાસ્ત્ર પ્રોફાઇલ",
      "secTraits": "તમારો મૂળ સ્વભાવ — ખૂબીઓ, નબળાઈઓ અને સુધારા",
      "secVedicGrid": "વૈદિક જન્મ ગ્રિડ — ગ્રહ-શક્તિ સંકેતકો",
      "secLoShuGrid": "લો શુ બ્લૂપ્રિન્ટ — તમારું Foundation",
      "secVedicCompare": "ઉન્નત વૈદિક તુલના",
      "secWeak": "લો શુ ઉપાય કિટ",
      "secTattva": "વૈદિક તલ સુમેળ — તત્વ સંતુલન",
      "secTattvaDesc": "ઊણા જન્મ-તલોને સ્થિર કરવા શારીરિક, શ્વાસ અને ઔષધિ આધાર. આ તમારી ૪૦-દિવસીય લો શુ સાધના સાથે ચાલે છે, વધારાની વિધિ-થાક વગર.",
      "secZodiac": "વૈદિક સૂર્ય રાશિ સંદર્ભ — {sign}",
      ...
      "secTiming": "દીર્ઘકાલીન વ્યક્તિગત-વર્ષ સંદર્ભ",
      "secDasha": "દશા સમય-રેખા — જીવન-ઘટના વિન્ડો",
      "fieldModeOn": "ક્ષેત્ર મોડ",
      "fieldModeOff": "ક્ષેત્ર મોડ બંધ કરો",
      "fieldModeToggle": "ક્ષેત્ર વાંચન મોડ ચાલુ/બંધ કરો",
      "fieldModeOnToast": "ક્ષેત્ર મોડ ચાલુ — મોટા અક્ષર, એક સ્તંભ, ઓછું વિક્ષેપક.",
      "fieldModeOffToast": "ક્ષેત્ર મોડ બંધ.",
      "vimshottariTitle": "શાસ્ત્રીય વિમ્શોત્તરી દશા — ચંદ્ર-નક્ષત્ર આધારિત",
      "vimshottariKicker": "વૈદિક · નક્ષત્ર-આધારિત · નિશ્ચિત ૧૨૦-વર્ષીય ચક્ર",
      "vimshottariIntro": "આ શાસ્ત્રીય વૈદિક વિમ્શોત્તરી ક્રમ છે: તેનો આધાર જન્મ સમયના ચંદ્રનું નક્ષત્ર છે અને તેમાં ગ્રહોની નિશ્ચિત અવધિઓ છે (કેતુ ૭, શુક્ર ૨૦, સૂર્ય ૬, ચંદ્ર ૧૦, મંગળ ૭, રાહુ ૧૮, ગુરુ ૧૬, શનિ ૧૯, બુધ ૧૭ વર્ષ). તે તમારી ચંદ્ર-સ્થિતિ પરથી ગણાય છે, મૂળાંક પરથી નહીં, અને અંક-જ્યોતિષ દશા રોડમેપથી સ્વતંત્ર રીતે ચાલે છે.",
      "vimshottariAnchorLabel": "આધાર",
      "vimshottariBalanceLabel": "જન્મ સમયે જન્મ-ગ્રહની બાકી અવધિ",
      "vimshottariBalanceNote": "દરેક નક્ષત્ર ૧૩°૨૦′નું હોય છે. તમે તેની વચ્ચે જન્મ્યા હતા, તેથી નક્ષત્રનો જે ભાગ વીતી ગયો તે પ્રારંભિક ગ્રહની અવધિમાંથી બાદ થાય છે અને બાકીનાં વર્ષ આગળ ચાલે છે.",
      "vimshottariLadderTitle": "મહાદશા ક્રમ (નિશ્ચિત ૧૨૦-વર્ષીય ચક્ર)",
      "vimshottariCurrentTitle": "વર્તમાન વિમ્શોત્તરી ક્રમ",
      "vimshottariCompareTitle": "આ અંક-જ્યોતિષ રોડમેપથી અલગ કેમ છે",
      "vimshottariCompareAgree": "બંને ગણતરીઓ આ સમયે એક જ સ્વામી ગ્રહ પર સહમત છે. આ આ ચોક્કસ આધારોનો સંયોગ છે, નિયમ નહીં — બંને પદ્ધતિઓ સ્વતંત્ર રહે છે.",
      "vimshottariCompareDiffer": "અહીં બંને ગણતરીઓ અલગ છે, અને તે અપેક્ષિત છે — ભૂલ નહીં. અંક-જ્યોતિષ રોડમેપ તમારા મૂળાંકથી ૪૫-વર્ષીય પ્રમાણસર આધાર પર બને છે; વિમ્શોત્તરી ક્રમ તમારા ચંદ્ર-નક્ષત્ર પર શાસ્ત્રીય ૧૨૦-વર્ષીય આધાર પર ટકે છે. એક બીજાને અધિક્રમિત કરતું નથી — આને બે અલગ વૈદિક પરંપરાઓ તરીકે વાંચો, જેમ કોઈ જ્યોતિષી અને કોઈ અંક-જ્યોતિષી પોતપોતાના શાસ્ત્રથી અલગ જણાવે.",
      "vimshottariNoTime": "શાસ્ત્રીય વિમ્શોત્તરી ક્રમ માટે તમારો ચોક્કસ જન્મ સમય અને માન્ય જન્મસ્થળ જરૂરી છે, કારણ કે તેનો આધાર ચંદ્રનું નક્ષત્ર છે, ફક્ત જન્મ તારીખ નહીં. તેને મેળવવા જન્મ સમય અને સ્થળ ભરો.",
      "vimshottariAge": "ઉંમર",
      "vimshottariBalanceTag": "જન્મથી બાકી અવધિ",
      "vimshottariMD": "મહાદશા",
      "vimshottariAD": "અંતર્દશા",
      "vimshottariPD": "પ્રત્યંતર",
      "vimshottariElapsed": "વીતી ગયું",
      "vimshottariBoundary": "આ મોડ્યુલ લો શુ ઉપાયો, વાસ્તુ ક્ષેત્રો કે અંક-જ્યોતિષ ઘટના-વિન્ડોને ક્યારેય બદલતું નથી. આ એક સ્વતંત્ર શાસ્ત્રીય વાંચન છે.",
      "dashaJudgeNote": "ઉપરનો રોડમેપ અમારી પ્રમાણસર અંક-જ્યોતિષ ગણતરી છે (મહાદશા × અંતર્દશા ÷ ૪૫): દરેક મહાદશા બરાબર પોતાના અંક જેટલાં વર્ષ ચાલે છે અને દરેક ઉપ-કાળ ગ્રહના ભાર પ્રમાણે વહેંચાય છે, જેથી મહાદશા, અંતર્દશા અને પ્રત્યંતર ત્રણેય સ્તર ચોક્કસ રીતે એકબીજામાં બેસે છે. આ શાસ્ત્રીય વિમ્શોત્તરી દશા <strong>નથી</strong> અને નક્ષત્ર-આધારિત કોઈ દાવો કરતી નથી — આ જ વિભાગનું અલગ <em>શાસ્ત્રીય વિમ્શોત્તરી</em> કાર્ડ જ ખરેખર નક્ષત્ર-આધારિત ક્રમ છે, અને બંનેનું અલગ હોવું સ્વીકાર્ય છે. <em>વૈકલ્પિક પદ્ધતિ:</em> કેટલાક આધુનિક અંકશાસ્ત્રીઓ અંતર્દશાને જન્મદિવસ-થી-જન્મદિવસ બરાબર ૧-વર્ષ ખંડ ગણે છે; બંને શાળાઓ પ્રચલિત છે, તારીખો થોડી અલગ આવી શકે છે. ઘટના-વિન્ડો ફક્ત સક્રિય મહાદશા-અંતર્દશાના કારક ગ્રહોથી બને છે; લો શુ અને વૈદિક જન્મ-ગ્રિડ તેને બદલતા નથી.",
      "dashaLadderNote": "આ સીડી ૮૦-વર્ષીય સરેરાશ-આયુષ્ય સીમાથી આગળ સુધી ગણાય છે જેથી દરેક જીવન-ઘટના પટ્ટી — ધન અને વેપાર સહિત ૭૫ સુધી — જીવનભર આવરી રહે.",
      "dashaCoverageNote": "કવરેજ: ધન અને વેપાર વિન્ડો ૨૧–૭૫ ઉંમર સુધી જોવાય છે, અને દરેક દશા-સીમા ૮૦-વર્ષીય સરેરાશ આયુષ્ય માને છે. શાસ્ત્રીય પટ્ટી બંધ થયા પછી મોડી વિન્ડો ૮૦ ઉંમર સુધી (કે ૧૫ વર્ષ આગળ, જે વધુ હોય) જોવાય છે, કાર્ડ ખાલી છોડાતું નથી.",
    ...
    "numbers": {
      "1": {
        ...
        "wearGuidance": "સોનેરી, કેસરીયું કે હળવું પીળું",
        "metal": "સોનું / તાંબું",
